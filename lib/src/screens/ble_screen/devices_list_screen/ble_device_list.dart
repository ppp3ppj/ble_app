...
import 'package:ble_app/src/widgets/ble_widget/ble_icon.dart';
import 'package:ble_app/src/widgets/ble_widget/ble_select_device_widget.dart';
...
class BleDeviceListScreen extends StatelessWidget {
  const BleDeviceListScreen({Key? key}) : super(key: key);
  @override
...
class _DeviceListState extends State<_DeviceList> {
  ...
  void dispose() {
    ...
    //! clear list scan
    log('clear scan device nowww');
    // log(_uuidController.text.toString());
    // log()
    super.dispose();
  }
                ...
                children: widget.scannerState.discoveredDevices
                    .map(
                      (device) => ListTile(
                        ...
                        onTap: () async {
                          widget.stopScan();
                          //TODO: select device and save to hive local database
                          log(device.toString());
                          bleSelectShowDialog(context, device);
